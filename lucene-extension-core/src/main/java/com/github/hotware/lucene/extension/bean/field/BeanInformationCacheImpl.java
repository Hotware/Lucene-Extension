 ...
 * ----------------------------------------------------------------------------
 */
package com.github.hotware.lucene.extension.bean.field;
...
import com.github.hotware.lucene.extension.bean.annotations.BeanFields;
...
public class BeanInformationCacheImpl implements BeanInformationCache {
	...
	private FieldInformation buildFieldInformation(BeanField bf, Field field,
		...
		try {
			...
			typeWrapper = (com.github.hotware.lucene.extension.bean.type.Type) bf
					.type().newInstance();
