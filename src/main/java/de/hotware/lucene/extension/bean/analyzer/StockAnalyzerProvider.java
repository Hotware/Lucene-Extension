...
public class StockAnalyzerProvider {
	...
	private static abstract class AnalyzerProviderTemplate implements AnalyzerProvider {
	...
	public static class KeyWordAnalyzerProvider extends AnalyzerProviderTemplate {
	...
	public static class EnglishAnalyzerProvider extends AnalyzerProviderTemplate {
